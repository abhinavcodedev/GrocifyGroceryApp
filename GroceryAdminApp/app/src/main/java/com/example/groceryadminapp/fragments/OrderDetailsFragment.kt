...
import com.example.groceryadminapp.adapter.AdapterCartProducts
import com.example.groceryadminapp.databinding.FragmentOrderDetailsBinding
...
class OrderDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        onBackButtonClick()
        onChangeStatucButtonClick()
        return binding.root
    }

    private fun onChangeStatucButtonClick() {
