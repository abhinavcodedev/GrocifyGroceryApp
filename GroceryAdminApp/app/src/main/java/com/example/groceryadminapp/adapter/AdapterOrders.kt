...
import com.example.groceryadminapp.databinding.ItemViewOrdersBinding
import com.example.groceryadminapp.models.OrderedItems



class AdapterOrders(val context: Context, val onOrderedItemViewClick: (OrderedItems) -> Unit) : RecyclerView.Adapter<AdapterOrders.OrdersViewHolder>() {
